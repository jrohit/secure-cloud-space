...
import { MoreHorizontal, MoreVertical, Download, Star, Trash2, RotateCcw } from "lucide-react"
  ...
  if (viewMode === 'grid') {
    return (
      ...
      >
        ...
        {getFileIcon()}
        <p className="text-sm font-medium line-clamp-1 text-center">{file.name}</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center ml-auto">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full p-0 ml-2">
              <MoreVertical className="h-4 w-4" />
